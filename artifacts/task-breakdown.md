...
| IT-6 | C 端观测页面 | P0 | 15 | FR-035, FR-038~042 | ⏳ |
...
| IT6-FE-013 | ⏳ | FilterPanel 组件：筛选条件（Agent 名称、时间范围、行为类型） | 前端组件 | P0 | FR-040 |
...
| 任务编号 | 状态 | 任务名称 | 类型 | 优先级 | 关联 FR |
|---------|------|---------|------|--------|---------|
| IT6-FE-017 | ⏳ | 全局样式：深色主题（`#0a0e27`）+ 霓虹蓝（`#00f0ff`）/紫色（`#b026ff`） | 前端样式 | P0 | FR-039 |
| IT6-FE-018 | ⏳ | 酒馆页暖色调主题：琥珀色（`#f59e0b`）、深红色（`#dc2626`） | 前端样式 | P0 | FR-040 |
| IT6-FE-019 | ⏳ | CSS3 动画效果：活动流淡入、悬停效果、滚动加载动画 | 前端样式 | P0 | FR-039, FR-040 |
| IT6-FE-020 | ⏳ | 响应式设计：移动端优先，Element Plus 栅格系统适配 | 前端样式 | P0 | FR-039, FR-040 |
