package com.aworld.framework.tenant.config;

import com.aworld.framework.common.biz.system.tenant.TenantCommonApi;
import com.aworld.framework.common.enums.WebFilterOrderEnum;
import com.aworld.framework.mybatis.core.util.MyBatisUtils;
import com.aworld.framework.redis.config.CacheProperties;
...
import com.aworld.framework.tenant.core.aop.TenantIgnoreAspect;
import com.aworld.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.aworld.framework.tenant.core.job.TenantJobAspect;
import com.aworld.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.aworld.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.aworld.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.aworld.framework.tenant.core.redis.TenantRedisCacheManager;
import com.aworld.framework.tenant.core.security.TenantSecurityWebFilter;
import com.aworld.framework.tenant.core.service.TenantFrameworkService;
import com.aworld.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.aworld.framework.tenant.core.web.TenantContextWebFilter;
import com.aworld.framework.tenant.core.web.TenantVisitContextInterceptor;
...
import static com.aworld.framework.common.util.collection.CollectionUtils.convertList;

@AutoConfiguration
@ConditionalOnProperty(prefix = "aw.tenant", value = "enable", matchIfMissing = true) // 允许使用 aw.tenant.enable=false 禁用多租户
