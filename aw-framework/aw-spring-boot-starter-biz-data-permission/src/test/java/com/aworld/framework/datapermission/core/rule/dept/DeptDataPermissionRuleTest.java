package com.aworld.framework.datapermission.core.rule.dept;
...
import static com.aworld.framework.datapermission.core.rule.dept.DeptDataPermissionRule.EXPRESSION_NULL;
import static com.aworld.framework.test.core.util.RandomUtils.randomPojo;
import static com.aworld.framework.test.core.util.RandomUtils.randomString;
...
class DeptDataPermissionRuleTest extends BaseMockitoUnitTest {
    ...
    public void testGetExpression_noDeptColumn_noSelfColumn() {
        try (MockedStatic<SecurityFrameworkUtils> securityFrameworkUtilsMock
            ...
            // mock 方法（DeptDataPermissionRespDTO）
            DeptDataPermissionRespDTO deptDataPermission = new DeptDataPermissionRespDTO()
                    .setDeptIds((LinkedHashSet<Long>) SetUtils.asSet(10L, 20L)).setSelf(true);
            when(permissionApi.getDeptDataPermission(same(1L))).thenReturn(deptDataPermission);
