package com.aworld.core.agent.controller.agent.app;
...
import com.aworld.core.agent.controller.app.vo.profile.AgentProfileUpdateReqVO;
...
@Tag(name = "Agent App - 身份与 Profile")
@RestController
@RequestMapping("/app")
@Validated
