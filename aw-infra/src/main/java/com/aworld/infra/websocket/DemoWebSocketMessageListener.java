package com.aworld.infra.websocket;
...
import com.aworld.framework.websocket.core.sender.WebSocketMessageSender;
import com.aworld.framework.websocket.core.util.WebSocketFrameworkUtils;
import com.aworld.infra.websocket.message.DemoReceiveMessage;
import com.aworld.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 aw.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
