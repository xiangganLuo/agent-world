package com.aworld.infra.controller.admin.codegen;
...
import com.aworld.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.aworld.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.aworld.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.aworld.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.aworld.infra.convert.codegen.CodegenConvert;
...
import com.aworld.infra.service.codegen.CodegenService;
...
import static com.aworld.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.aworld.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "aw"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "AWorld")
    })
