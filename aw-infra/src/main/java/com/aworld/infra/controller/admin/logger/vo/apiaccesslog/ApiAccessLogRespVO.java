package com.aworld.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.aworld.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "结果提示", example = "AWorld，牛逼！")
    @ExcelProperty("结果提示")
