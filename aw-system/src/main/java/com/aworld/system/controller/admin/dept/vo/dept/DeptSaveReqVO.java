package com.aworld.system.controller.admin.dept.vo.dept;
...
public class DeptSaveReqVO {
    ...
    @Schema(description = "部门名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "aw")
    ...
    @Schema(description = "邮箱", example = "aw@iocoder.cn")
