package com.aworld.system.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 数据权限配置 1-002-029-000 ==========
    ErrorCode DATA_PERMISSION_CONFIG_NOT_EXISTS = new ErrorCode(1_002_029_000, "数据权限配置不存在");
    ErrorCode DATA_PERMISSION_CONFIG_KEY_DUPLICATE = new ErrorCode(1_002_029_001, "已经存在配置键为【{}】的数据权限配置");
