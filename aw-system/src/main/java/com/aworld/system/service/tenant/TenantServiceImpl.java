package com.aworld.system.service.tenant;
...
import com.aworld.framework.tenant.config.TenantProperties;
import com.aworld.framework.tenant.core.context.TenantContextHolder;
import com.aworld.framework.tenant.core.util.TenantUtils;
import com.aworld.system.controller.admin.permission.vo.role.RoleSaveReqVO;
import com.aworld.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.aworld.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.aworld.system.convert.tenant.TenantConvert;
import com.aworld.system.dal.dataobject.permission.MenuDO;
import com.aworld.system.dal.dataobject.permission.RoleDO;
import com.aworld.system.dal.dataobject.tenant.TenantDO;
import com.aworld.system.dal.dataobject.tenant.TenantPackageDO;
import com.aworld.system.dal.mysql.tenant.TenantMapper;
import com.aworld.system.enums.permission.RoleCodeEnum;
import com.aworld.system.enums.permission.RoleTypeEnum;
import com.aworld.system.service.permission.MenuService;
import com.aworld.system.service.permission.PermissionService;
import com.aworld.system.service.permission.RoleService;
import com.aworld.system.service.tenant.handler.TenantInfoHandler;
import com.aworld.system.service.tenant.handler.TenantMenuHandler;
import com.aworld.system.service.user.AdminUserService;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 aw.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
