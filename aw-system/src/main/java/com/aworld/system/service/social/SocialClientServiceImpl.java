package com.aworld.system.service.social;
...
import com.aworld.framework.common.util.http.HttpUtils;
import com.aworld.framework.common.util.object.BeanUtils;
import com.aworld.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.aworld.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.aworld.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.aworld.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.aworld.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.aworld.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.aworld.system.dal.dataobject.social.SocialClientDO;
import com.aworld.system.dal.mysql.social.SocialClientMapper;
import com.aworld.system.dal.redis.RedisKeyConstants;
import com.aworld.system.enums.social.SocialTypeEnum;
import com.aworld.system.framework.justauth.core.AuthRequestFactory;
...
import static com.aworld.framework.common.util.collection.MapUtils.findAndThen;
import static com.aworld.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.aworld.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.aworld.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${aw.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${aw.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/aw-cloud/pulls/230
